...
export default function Home() {
  ...
  const handleSubmitOrder = async () => {
    if (areFieldsFilled()) {
      ...
      console.log(
        ...
        calculateCharge(orderDetails.quantity)
      );
  ...
  const renderOrderDetails = () => (
    <div
      style={{ backgroundColor: "#f0f0f0", minHeight: "100vh", height: "auto" }}
    >
      <img
      ...
      <h3 className="order-subheader">
        *Please note that online purchases are only available for the Lower
        Mainland region
      </h3>
      <form className="order-form">
        ...
        <div className="form-group">
          <h3>
            Billing Details (card payment will be requested in the next page){" "}
          </h3>
  ...
  const renderPaymentDetails = () => {
    ...
    const finalPrice = (
      ...
      shippingAmount
    ).toFixed(2); // Add tax to the original amount
        ...
        >
          ...
          <div>
            ...
            <p className="payment-text">
              Total Cost: ${finalPrice} CAD <br /> <br />{" "}
            </p>
            <p className="payment-text">
              Upon successful payment, you will be redirected
            </p>
  ...
  const renderThankYou = () => {
    return (
      ...
      >
        ...
        {/* Thank You Message */}
        <h2 style={{ color: "#333", fontSize: "28px", margin: "20px 0" }}>
        ...
        >
          We’ve received your order and are processing it. You’ll receive a
          confirmation email shortly with the details. If you have any
          questions, feel free to{" "}
          <a
            href="mailto:secondsavour@enactussfu.com"
            style={{ color: "#007BFF" }}
          >
            contact us
          </a>
        ...
        <p style={{ marginTop: "30px", fontSize: "16px", color: "#777" }}>
          Explore more on our{" "}
          <a href="https://www.secondsavour.ca/" style={{ color: "#007BFF" }}>
            homepage
          </a>
          .
        </p>
